...
export const resumeHref =
	'https://drive.google.com/file/d/1D0s2JTQ7ZhMcDm2LtgrWJoe9d7VfPopW/view';
			...
			>
				...
				<Grid item xs={12} md={6}>
					...
					<Typography variant="body1" align="center" paragraph>
						Hello! I'm Diraj, a passionate software engineer with expertise in
				...
				<Grid container spacing={2} justifyContent="center" py={2}>
					...
					<Grid item>
						<Button
							variant="contained"
							startIcon={<LinkedIn />}
							href="https://linkedin.com/in/diraj-thajali"
						>
							LinkedIn
						</Button>
					</Grid>
					<Grid item>
						<Button
							variant="contained"
							startIcon={<GitHub />}
							href="https://github.com/dthajal1"
						>
							GitHub
						</Button>
					</Grid>
