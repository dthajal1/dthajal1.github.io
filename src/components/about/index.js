    ...
    <Box sx={{ px: { xs: '5%', sm: '20%' }, py: 6, backgroundColor: 'background.paper' }}>
      <Grid container id="about-me" spacing={2}>
        <Grid item>
          ...
          I am a software engineer with a focus on backend and full stack development. 
          I graduated from UC Berkeley with a degree in EECS and have hands-on experience 
          with Python, Next.js, Node/Express.js, and React.js. I have built personal projects 
          with them and also have used them extensively in my career thus far.
          </Typography>
          <Typography paragraph>
